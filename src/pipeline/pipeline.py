...
if __name__=='__main__':
    ...
    #         "channels" :
    #             [
    #                 {"channel":0, "URI":"s3://lixiang-lambda-test/sintel.mp4", "nchunks":null, "type":"mp4", "src":"src", "dest":null},
    ...
    #                 {"channel":3, "URI":"s3://lixiang-lambda-test/output/%06d.mp4", "nchunks":null, "type":"mp4", "src":null, "dest":"dest"}
    #             ],
    #         "nodes" :
    #             [
    ...
    pipe = '''{
            ...
            "channels" :
                [
                    {"channel":0, "URI":"s3://lixiang-lambda-test/sintel.mp4", "nchunks":null, "type":"mp4", "src":"src", "dest":null},
                    {"channel":1, "URI":"s3://lixiang-lambda-test/temp/2S1H8nx5/1/%08d.png", "nchunks":null, "type":"png", "src":null, "dest":"dest"}
                ],
            "nodes" :
                [
                    {"node":0, "upstream":[0], "downstream":[1], "nworkers":10, "nchunks":null, "amplification":1, "engine": "aws-lambda", "operator": "decode", "command":[]}
