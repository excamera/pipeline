...
class RunState(CommandListState):
    ...
    commandlist = [ (None, 'run:mkdir -p ##TMPDIR##/in_0/')
                  ...
                  , ('OK:RETVAL(0)', 'run: python lambdaRek_sceneInsert_opt_mt.py ' +\
                          '"{person}" ##TMPDIR##/in_0/*.png ##TMPDIR##/out_0/ 300 70 5 0.1 {lineage}') #for _opt_mt
    ...
    def __init__(self, prevState):
        ...
        params = {'in_key': self.in_events['frames']['key'],
                ...
                'lineage':self.in_events['frames']['metadata']['lineage']}
